...
class CaptionTSVDataset(Dataset):
    def __init__(self, yaml_file, tokenizer=None, add_od_labels=True,
        ...
        self.label_tsv = None if not self.label_file else TSVFile(self.label_file, True)
        self.feat_tsv = TSVFile(self.feat_file, True)
...
def ic_args_parser():
    ...
    parser.add_argument("--data_dir", default='oscar/datasets/test_images', type=str, required=False,
    ...
    parser.add_argument("--eval_model_dir", type=str, 
                        default='oscar/model_ckpts/image_captioning/checkpoint-29-66420/', 
...
def main():
    ...
    global logger
    import os; os.environ["CUDA_VISIBLE_DEVICES"] = "6"
