...
def test(args, model, eval_dataset=None, prefix=""):
    ...
    with open(args.data_dir + ('/{}_results.json'.format(eval_dataset.name)), 'w') as fp:
...
def vqa_args_parser():
    ...
    #### Required parameters ####
    parser.add_argument("--data_dir", default='oscar/datasets/test_images', type=str,
                        help="The input data dir. Should contain the .tsv files (or other data files) for the task.")
    parser.add_argument("--txt_data_dir", default='oscar/datasets/test_images', type=str,
    ...
    parser.add_argument("--output_dir", default='oscar/model_ckpts/vqa/vqa_base_best', type=str,
                        help="The output directory where the model predictions and checkpoints will be written.")
    parser.add_argument("--label_file", type=str, default='oscar/datasets/vqa/cache/trainval_ans2label.pkl',
                        help="Label Dictionary")
    parser.add_argument("--label2ans_file", type=str, default='oscar/datasets/vqa/cache/trainval_label2ans.pkl', 
                        help="Label to Answer Dictionary")
    #############################
